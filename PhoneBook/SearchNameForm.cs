...
namespace PhoneBook
{
    public partial class Поиск_абонента : Form
    {
        List<Note> PhoneNote;
        public Поиск_абонента(List<Note> _PhoneNote)
        {
            InitializeComponent();
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (Note MyRecord in PhoneNote)
            {
                ...
                MyRecord.Name.Contains(NameTextBox.Text) &&
                MyRecord.Patronymic.Contains(PatronymicTextBox.Text))
                {
